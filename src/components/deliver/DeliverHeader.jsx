export default function DeliverHeader() {
    return (
      <div className="relative w-full overflow-hidden h-[6rem] bg-blue-500 mb-1">
        <div className="absolute inset-y-0 -right-2 w-[40%] -skew-x-12 bg-blue-900"></div>
        <div className="flex max-w-[1700px] w-full h-full relative z-10 mx-auto">
          ...
          <div className="flex items-center justify-center w-[40%]">
            ...
            <div className="-skew-x-12 border border-white bg-white p-2.5 mx-2">
              <p className="skew-x-12 font-black tracking-tight text-sm text-blue-500">
                Get a free quote
              </p>
            </div>
          </div>
