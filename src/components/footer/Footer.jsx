    ...
    <div className="h-[390px] bg-blue-900 w-full antialiased">
      <div className="flex w-full justify-between px-28  pb-12 pt-10">
        ...
        <div className={footerStyles.col}>
          ...
          <div className="w-[30%] border-t border-blue-200 border-2"></div>
        ...
        <div className={footerStyles.col}>
          ...
          <div className="mt-2 text-sm -skew-x-12 flex items-center justify-center font-semibold whitespace-nowrap h-[25%] w-[96%] bg-white text-blue-500 py-2 px-4">
