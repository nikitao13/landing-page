    ...
    <div className="relative w-full overflow-hidden h-[6rem] bg-[#0274ff] mb-1">
      ...
      <div className="flex max-w-[1700px] w-full h-full relative z-10 mx-auto">
        ...
        <div className="flex items-center justify-center w-[40%]">
          <div className="hover:opacity-80 hover:cursor-pointer -skew-x-12 border border-white p-2.5 mx-2">
            <p className="skew-x-12 font-black tracking-tight text-sm text-white">
              1300 000 000
            </p>
          </div>
          <div className="hover:opacity-80 hover:cursor-pointer -skew-x-12 border border-white bg-white p-2.5 mx-2">
